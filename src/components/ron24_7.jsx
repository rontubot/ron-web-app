...
const Ron24_7 = () => {  
  ...
  // NUEVO: Estado para progreso de descarga/instalación  
  ...
  return (  
    <div className="ron247-container">  
      {/* NUEVO: Overlay de progreso de descarga/instalación */}  
      {downloadProgress && (  
        <div className="download-progress-overlay">  
          <div className="download-progress-content">  
            ...
            {downloadProgress.stage === 'installing' && (  
              <p className="progress-note">Primera instalación - esto puede tomar unos minutos</p>  
            )}  
          </div>  
        </div>  
      )}  
